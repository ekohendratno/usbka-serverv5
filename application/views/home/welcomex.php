...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/util1.css">

<div class="bg-img1 size1 overlay1 p-t-100" style="background-image: url('<?php echo base_url();?>assets/images/banner647.jpg');">
    ...
    <div class="flex-w flex-sb-m p-l-80 p-r-74 p-b-50 respon5">
        ...
        <div class="animated bounceInRight bg0 wsize1 bor1 p-l-45 p-r-45 p-t-50 p-b-18 p-lr-15-sm">
            ...
            <p class="s1-txt3 txt-center p-l-15 p-r-15 p-t-25">
                Login menggunakan Username NISN dan Password NIS
            </p>
        </div>
    </div>
