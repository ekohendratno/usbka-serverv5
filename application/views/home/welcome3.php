...
<div class="modal fade in" id="formLogin" tabindex="-1" role="dialog" aria-labelledby="formLogin" aria-hidden="true">
    <!-- begin login -->
    <div class="login bg-blue animated fadeInDown">
        <!-- begin brand -->
        <div class="login-header">
            <div class="brand">
                <div class="col-lg-12 col-md-12 col-md-offset-0 col-xs-12 col-xs-offset-1">
                    <div class="row">
                ...
                <span class="logo">
                    <img src="<?php echo base_url(); ?>assets/images/logocbt.ico" style="width: 40px" alt="cbt sekolah">
                        ...
                        <small style="margin-top: 10px;">Aplikasi Pengelolaan Ujian Sekolah</small>
            ...
            <div class="col-lg-4 col-md-4 col-md-offset-4">
                <div class="row">
                    ...
                    <form method="POST" action="<?php echo base_url();?>" id="client-login-form">
                        ...
                        <div class="form-group form-group-lg step1">
                            <label class="control-label" for="reg-email">Username</label>

                            <div class="input-group input-group-lg">

                                <input id="reg-email" class="form-control" type="text" required="required" name="username" placeholder="Masukkan Username">
                        ...
                        <div class="form-group form-group-lg step1">
                            ...
                            <div class="input-group input-group-lg">
                                <input id="reg-password" class="form-control pwd" type="password" required="required" name="password" placeholder="Masukkan Password">
                        ...
                        <div class="form-group  step1">
                            ...
                            <button onclick="signin()" type="button" id="btn-tambah" class="btn btn-block btn-lg btn-success">MASUK</button>
