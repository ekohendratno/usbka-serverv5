...
<section id="hero-area" class="bg-img1 size1 overlay1" style="padding-top: 60px; background-image: url('<?php echo base_url();?>assets/images/banner647.jpg');">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 animated fadeInRight delay-0-5">
                    ...
                    <h2 class="subtitle branded" style="color: #fff">Pengelola tes mandiri!</h2>
                    <p>
                        Permudah semua akses dan kebutuhan sekali penugasan, tanpa ribet, hemat kertas, dan tentunya
                        ramah bagi peserta dan sekolah
                    </p>
                    <div class="row">

                        <div class="col-md-6 btn-dl">
                            <a href="<?php echo base_url(); ?>download/android" class="btn btn-primary btn-lg btn-block"><i class="glyphicon glyphicon-download"></i> Download CBT</a>
                        </div>

                        <div class="col-md-6 btn-dl">
                            <a data-toggle="modal" data-target="#formTonton"  title="Tonton" class="btn btn-default btn-lg btn-block"><i class="glyphicon glyphicon-play-circle"></i> Tonton Video</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade in" id="formLogin" tabindex="-1" role="dialog" aria-labelledby="formLogin" aria-hidden="false">
    <!-- begin login -->
            ...
            <div class="brand">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <div class="row text-center">
                        ...
                        <img src="<?php echo base_url(); ?>assets/images/cbt_text.png" style="width: 120px" alt="cbt sekolah">
                ...
                <div class="row">
                    ...
                    <form method="POST" action="<?php echo base_url();?>" id="client-login-form">
                        ...
                        <div class="form-group  step1">
                            ...
                            <button onclick="signin()" type="button" id="btn-tambah" class="btn btn-block btn-lg btn-success">MASUK SEKARANG</button>
