...
<section id="hero-area" style="padding-top: 60px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">

                <div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 animated fadeInRight delay-0-5">

                    <div class="text-center">
                        <img width="125" class="animated fadeInDown" src="<?php echo base_url();?>assets/images/cbt_text.png?t=1" alt="">
                    </div>
                    <h2 class="subtitle branded">Perangkat lunak tercepat dan termudah untuk mengelola tes berbasis komputer bagi sekolah maupun mandiri!</h2>
                    <p>
                        Software yang tepat untuk memenagament jaringan ujian sekolah dalam satu wadah.
                        Permudah semua akses dan kebutuhan hanya sekali penugasan, tanpa ribet, hemat kertas, dan tentunya
                        ramah bagi peserta dan sekolah
                    </p>
                    <div class="row">

                        <div class="col-md-6 btn-dl">
                            <a href="<?php echo base_url(); ?>download/android" class="btn btn-success btn-lg btn-block">Download CBT</a>
                        </div>

                        <div class="col-md-6 btn-dl">
                            <a data-toggle="modal" data-target="#formTonton"  title="Tonton" class="btn btn-default btn-lg btn-block">Tonton Video</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="service-item">
                    ...
                    <p>Untuk memudahkan dalam proses memasukkan soal, cbt dapat menerima soal dari dokumen Microsoft Excel, Microsoft Word, atau ZIP menggunakan template yang sudah disiapkan.</p>
                </div>
            </div>
...
<div class="modal animated fadeInDown login modal-fullscreen" id="formLogin" tabindex="-1" role="dialog" aria-labelledby="formLogin" aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-11 col-md-7">
                                <div class="box-singup">
                                    <span class="font-m-light font-size-12 hidden-sm hidden-xs">Anda peserta ujian? Silahkan kunjungi link berikut </span>
                                    <a target="_blank" href="<?php echo base_url(); ?>auth/client">
                                        <button class="btn btn-singup-outline btn-sm font-m-normal">Area peserta!</button>
                                    </a>
                                    <button class="btn btn-singup-outline btn-sm font-m-normal" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" class="fas fa-times"></span></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <form method="POST" action="<?php echo base_url();?>" id="client-login-form">
                                <div class="form-group step1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <span class="btn btn-default" style="margin-left: 1px">
                                ...
                                <div class="form-group step1">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <span class="btn btn-default passwordshow" style="margin-left: 1px">
...
<div class="modal animated fadeInDown modal-fullscreen" id="formTonton" tabindex="-1" role="dialog" aria-labelledby="formTonton" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">TONTON VIDEO
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-offset-3 col-xs-12">
                            ...
                            <iframe
                                width="100%"
                                height="315"
                                src="https://www.youtube.com/embed/QTySm32bnh0"
...
<style>
    ...
    .wrap-fit{position: fixed; height: 100%; width: 460px; left: 0; background: url(<?php echo base_url(); ?>assets/images/promo1.png); background-size: cover; }
