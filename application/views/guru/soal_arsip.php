        ...
        <div>
            <div style="min-height:800px;">
                ...
                <ul class="nav nav-tabs" style="margin-bottom: 8px">
                    <li class="active"><a data-toggle="tab" href="#soalterbaru">Soal Arsip Terbaru</a></li>
                    <li><a data-toggle="tab" href="#soalterkumpul">Soal Arsip Terkumpul</a></li>
                </ul>
            ...
            <div class="modal-header">
                <h4 class="modal-title">Filter
                    <div class="pull-right">
                        <a href="<?php echo base_url(). "guru/soalarsip/index"; ?>" class="btn btn-primary">Atur Ulang Setingan</a>
...
<script type="text/javascript" language="javascript" >
    ...
    function submitTahunAjaran(){
        ...
        $.ajax({
            ...
            url:'<?php echo base_url('index.php/guru/soalarsip/simpantahunajaran_arsip') ;?>',
            beforeSend: function () {
                $('#loading_ajax').show();
            },
            success: function(){
                ...
                /**
                setTimeout(function() {
                    window.location.assign("<?php echo base_url('index.php/guru/soalarsip') ;?>");
                }, 300);*/
            }
        });
    }
    ...
    $(document).ready(function(){
        ...
        $('[name="soal_pelajaran"]').on('change', function() {
            ...
            $.ajax({
                ...
                url:'<?php echo base_url('guru/soalarsip/getguru') ;?>',
                cache: false,
                dataType:'json',
    ...
    function searchFilter(page_num) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>guru/soalarsip/ajaxPaginationData/'+page_num,
            data:
                'page='+page_num+
                '&keywords='+keywords+
                '&sortBy='+sortBy+
    ...
    function searchFilterBySoal(page_num) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>guru/soalarsip/ajaxPaginationDataBySoal/'+page_num,
    ...
    function searchFilterParent(page_num) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?php echo base_url(); ?>guru/soalarsip/ajaxPaginationData2/'+page_num,
    ...
    function searchFilterTerkumpul(page_num) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>guru/soalarsip/ajaxPaginationDataTerkumpul/'+page_num,
    ...
    function formDialog(id) {
        ...
        if(id > 0){
            ...
            $.ajax({
                type: "GET",
                data: 'id='+id,
                url: "<?php echo site_url('guru/soalarsip/ambildatabyid'); ?>",
                cache: false,
                dataType:'json',
                beforeSend: function () {
                    $('#loading_ajax').show();
                ...
                success: function(data){
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo site_url('guru/soalarsip/ambildatabyid3'); ?>",
                        cache: false,
                        dataType:'json',
                        beforeSend: function () {
                            $('#loading_ajax').show();
    ...
    function formDialog2(id) {
        ...
        if(id > 0){
            ...
            $.ajax({
                type: "GET",
                data: 'id='+id,
                url: "<?php echo site_url('guru/soalarsip/ambildatabyid2'); ?>",
                cache: false,
                dataType:'json',
                beforeSend: function () {
                    $('#loading_ajax').show();
    ...
    function submitHapus(id) {
        ...
        if(tanya){
            $.ajax({
                type:'GET',
                data: 'id='+id,
                url:'<?php echo base_url('guru/soalarsip/hapus') ;?>',
                cache: false,
                dataType:'json',
                success: function(hasil){
    ...
    function submitHapus2(id) {
        ...
        if(tanya){
            $.ajax({
                type:'GET',
                data: 'id='+id,
                url:'<?php echo base_url('guru/soalarsip/hapus2') ;?>',
                cache: false,
                dataType:'json',
                success: function(hasil){
                    $('#Notifikasi').html('<p class="alert alert-danger">'+hasil.pesan+'</p>');
    ...
    function submitHapusParent(id) {
        ...
        if(tanya){
            $.ajax({
                type:'GET',
                data: 'id='+id,
                url:'<?php echo base_url('guru/soalarsip/hapus_parent') ;?>',
                cache: false,
                dataType:'json',
                success: function(hasil){
                    $('#Notifikasi').html('<p class="alert alert-danger">'+hasil.pesan+'</p>');
        ...
        if(tanya){
            $.ajax({
                ...
                data: 'kelas='+soal_kelas+
                    ...
                    '&untuk='+soal_untuk,
                url:'<?php echo base_url('guru/soalarsip/hapus3') ;?>',
                cache: false,
                dataType:'json',
                success: function(hasil){
                    $('#Notifikasi').html('<p class="alert alert-danger">'+hasil.pesan+'</p>');
