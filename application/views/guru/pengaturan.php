...
<div class="container container-medium">
				...
				<div class="panel panel-default">
					<div class="panel-heading clearfix">
                        ...
                        <div class="panel-title-button pull-right">
                            <button onclick="resetdata()" type="button" id="btn-reset" class="btn btn-danger btn-sm">Reset Data Saya</button>
                        </div>
					</div>
	...
	<script type="text/javascript">
		...
		function callTA(){
			...
			$.ajax({
				type:'POST',
				url:'<?php echo base_url('guru/pengaturan/daftarta') ;?>',
				dataType: 'json',
        ...
        function resetdata(x){
            var tanya = confirm('Apakah yakin mau mereset semua data?');
            if(tanya){
                $.ajax({
                    type:'POST',
                    url:'<?php echo base_url('index.php/guru/pengaturan/resetdata') ;?>',
                    success: function(){
