...
<div class="container container-medium">
    ...
    <div class="col-sm-12 col-md-12">
        ...
        <h4 class="panel-title">DAFTAR UJIAN</h4>
        <hr/>
        <div class="panel-title-button pull-right">
            <a href="javascript:void(0);" onclick="searchFilter(0,0)" id="listUjianToday" class="btn btn-success btn-sm">Sekarang</a>
            <a href="javascript:void(0);" onclick="searchFilter(0,1)" id="listUjianTomorrow" class="btn btn-success btn-sm">Besok</a>
            <a href="javascript:void(0);" onclick="searchFilterHistory(0)" id="listUjianHistory" class="btn btn-default btn-sm">Semua Daftar</a>
...
<script type="text/javascript">
    ...
    $('h4.panel-title').html("<i class='fa fa-file fa-fw'></i> DAFTAR UJIAN HARI INI");
    ...
    $('#listUjianTomorrow').click(function(){
        $('h4.panel-title').html("<i class='fa fa-file fa-fw'></i> DAFTAR UJIAN BESOK");
        $('#listUjianHistory').removeClass('btn-success');
        $('#listUjianHistory').addClass('btn-default');
    ...
    $('#listUjianHistory').click(function(){
        $('h4.panel-title').html("<i class='fa fa-file fa-fw'></i> DAFTAR UJIAN DIKERJAKAN");
    ...
    function searchFilter(page_num,besok) {
        ...
        $.ajax({
            ...
            data:'todayBy='+besok+'&page='+page_num,
            dataType:'json',
            beforeSend: function () {
                $('#loading_ajax').show();
            },
