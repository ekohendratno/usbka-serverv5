    ...
    <table style="width:6.6cm;border:1px solid #112a47;  font-size: 14px; class="kartu">
        ...
        <tr>
            <td style="text-align: center;  padding: 10px;">
                ...
                <div class="qrcode1" id="qr_'.$item['urut'].'" data-value="https://cbt.smkn1candipuro.sch.id/auth/signin_auto?level=guru&key='.$key.'" title="'.$item['urut'].'"></div>
                <br/>
        ...
        <tr>
            ...
            <table style="width:100%;">
                <tr>
                    <td colspan="3"><strong style="font-size: 14px">'.$item['guru_nama']. '</strong></td>
                </tr>
                <tr>
                    <td>
                        <table class="table" style="width:100%;border:0.3px solid #858987;"  >
                        <tr>
                            <td align="left" style="padding-top: 8px;padding-bottom: 8px">Akun Login</td><td width="1">:</td><td align="left"><span style="font-size:12px;font-weight:bold;">' .$item['guru_username'].'</span></td>
                        </tr>
                        <tr>
                            <td align="left" style="padding-top: 8px;padding-bottom: 8px">Kata Sandi</td><td width="1">:</td><td align="left"><span style="font-size:12px;font-weight:bold;">'.$item['guru_password'].'</span></td>
                        </tr>
                        </table>
                    </td>
                </tr>
