...
foreach($peserta as $item){
    ...
    $judul_kartu = 'KARTU AKUN PESERTA UKK';
    ...
    <table style="width:6.6cm; border:1px solid #112a47;  font-size: 14px; class="kartu">
        ...
        <tr>
            <td style="text-align: center;  padding: 10px;">
                ...
                <div class="qrcode1" id="qr_'.$item['urut'].'" data-value="https://ukk.smkn1candipuro.sch.id/peserta&key='.$key.'" title="'.$item['urut'].'"></div>
                <br/>
                <span>https://<strong>ukk.smkn1candipuro.sch.id</strong></span>
                </div>
