                            ...
                            <div id="pengaturan" class="row" style="padding-top: 30px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8" style="display:none;">
                                        ...
                                        <label>Jurusan</label> * jika lebih dari 2 jurusan dg soal yg sama pilih semua jurusan
                                        <div class="input-group">
												  <span class="input-group-addon">
													<span class="glyphicon glyphicon-search"></span>
												  </span>

                                            <select name="soal_jurusan" class="form-control selectpicker" data-live-search="true">
                ...
                <div class="modal-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-6 col-xs-8">
                            <div class="pull-right">
                                <a href="<?php echo base_url();?>export/rekap_pembuatsoal" class="btn btn-default"><span class="fas fa-save"></span> Download Rekap</a>
...
<script type="text/javascript" language="javascript" >
    ...
    $(document).ready(function(){
        ...
        $('[name="soal_kelas"]').on('change', function() {
            var kelas = $('[name="soal_kelas"]').val();
            var untuk = $('[name="soal_untuk"]').val();
            $.ajax({
                type:'GET',
                data: 'kelas='+kelas+'&untuk='+untuk,
                url:'<?php echo base_url('admin/soal/getpelajaranbykelas') ;?>',
                cache: false,
                dataType:'json',
                success: function(hasil){

                    $('[name="soal_pelajaran"]').empty();
                    $('[name="soal_guru"]').empty();
                    for(emp in hasil){
                        $('[name="soal_pelajaran"]').append('<option value="'+hasil[emp]+'">'+hasil[emp]+'</option>');
                    }
        ...
        $('[name="soal_pelajaran"]').on('change', function() {
            ...
            $.ajax({
                ...
                url:'<?php echo base_url('admin/soal/getgurubykup') ;?>',
                cache: false,
                dataType:'json',
                success: function(hasil){
                    ...
                    $('[name="soal_guru"]').empty();
                    for(emp in hasil){
                        $('[name="soal_guru"]').append('<option value="'+hasil[emp]+'">'+hasil[emp]+'</option>');
                    }
        ...
        $('[name="soal_pelajaran"]').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(hasil){
                    ...
                    $("[name='soal_jurusan']").val(hasil.label3);
                    $("[name='soal_jurusan']").selectpicker('refresh');
